...
def main():
    ...
    # Build root transform: ENU-to-ECEF with Rx(-90°) baked in to correct GLB axis flip.
    # GLB geometry is exported in (East, Up, -North) local space.
    # Rx(-90°) swaps the Up/North axes so buildings stand upright on the globe.
    # Column-major 4x4, columns: East, South, Up, Origin
    enu_to_ecef = [
